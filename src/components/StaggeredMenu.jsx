...
export const StaggeredMenu = ({
  ...
  menuButtonColor = '#00ff41',
  openMenuButtonColor = '#050a05',
  accentColor = '#00ff41',
  ...
  return (
    ...
    >
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors.slice(0, 4) : ['#00ff41', '#00e5ff'];
          let arr = [...raw];
          if (arr.length >= 3) {
