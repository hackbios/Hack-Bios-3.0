          ...
          {isExpanded && (
            ...
            >
              ...
              <img 
                ...
                className="absolute inset-0 w-full h-full object-cover opacity-20 grayscale invert"
                alt="Map Background"
              />
              ...
              />
              <motion.div
                className="absolute top-[18%] left-[75%] w-[14%] h-[10%] rounded-sm bg-muted-foreground/22 border border-muted-foreground/15"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
